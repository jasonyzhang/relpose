...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default="data/co3dv1_annotations")
    parser.add_argument("--co3d_v1_dir", type=str, default="data/co3dv1")
    parser.add_argument(
        "--min_quality",
        type=float,
        default=0.5,
...
def precompute_bbox(co3d_v1_dir, category, output_dir):
    """
    ...
    """
    category_dir = osp.join(co3d_v1_dir, category)
...
def process_poses(co3d_v1_dir, category, output_dir, min_quality):
    category_dir = osp.join(co3d_v1_dir, category)
    ...
    with open(subset_lists_file) as f:
        # Splits are: train_known, train_unseen, test_known, test_unseen
